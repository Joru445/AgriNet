              ...
              >
                <div className="relative flex items-center justify-center">
                  ...
                  {isMessages && unreadCount > 0 && (
                    <Badge count={unreadCount} className="!-top-1 !-right-2 min-w-[0.875rem] h-3.5 px-0.5 text-[9px] ring-2 ring-white" />
                  )}
                  {isInquiries && inquiryActionCount > 0 && (
                    <Badge count={inquiryActionCount} className="!-top-1 !-right-2 min-w-[0.875rem] h-3.5 px-0.5 text-[9px] ring-2 ring-white" />
                  )}
                  {isReports && pendingReportsCount > 0 && (
                    <Badge count={pendingReportsCount} className="!-top-1 !-right-2 min-w-[0.875rem] h-3.5 px-0.5 text-[9px] ring-2 ring-white" />
                  )}
                </div>
