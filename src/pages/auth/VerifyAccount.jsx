        ...
        <div className="relative z-10 w-full max-w-md bg-white/95 backdrop-blur-md border border-white/60 shadow-2xl rounded-2xl p-5 sm:p-7 md:p-9 lg:bg-white lg:border-transparent lg:shadow-xl lg:backdrop-blur-none my-auto">
          ...
          {step === "phone" && (
            <form onSubmit={handleSendOtp} className="space-y-4">
              ...
              <Button
                ...
                loading={sendingOtp}
                icon={sendingOtp ? undefined : "ri-send-plane-fill"}
                fullWidth
              >
                {sendingOtp ? t("auth.verify.sendingCode") : t("auth.verify.sendCode")}
              </Button>
            </form>
          )}
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-4">
              ...
              <div className="space-y-2.5">
                <Button
                  ...
                  icon={verifyingOtp ? undefined : "ri-checkbox-circle-fill"}
                  fullWidth
                >
                  {verifyingOtp ? t("auth.verify.verifying") : t("auth.verify.verifyContinue")}
                </Button>
          ...
          <div className="mt-4 pt-3 border-t border-gray-100 text-center">
            <Button
              ...
              disabled={loggingOut}
              loading={loggingOut}
              icon={loggingOut ? undefined : "ri-logout-box-r-line"}
            >
